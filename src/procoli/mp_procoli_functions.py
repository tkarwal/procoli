...
class lkl_prof:
    ...
    def __init__(self, chains_dir, info_root, prof_param, processes=6, 
                 R_minus_1_wanted=0.05, 
    ...
    def global_min(self, run_glob_min=False, N_min_steps=3000, run_minuit=False):
        ...
        if run_glob_min:
            ...
            if self.jump_fac is None:
                self.jump_fac = [1, 0.8, 0.5, 0.2, 0.1, 0.05]
            if self.lkl_fac is None:
    ...
    def run_minimizer(self, min_folder="lkl_prof", prev_bf=None, N_steps=5000, 
        ...
        #   defaults, provided by Yashvi Patel
        if self.jump_fac is None:
